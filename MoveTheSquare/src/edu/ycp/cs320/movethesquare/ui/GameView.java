...
public class GameView extends JPanel {
	...
	private static final Color PINK = new Color(233, 41, 233);
	...
	public GameView(Game model) {
		...
		//sam-mac: changed the color from MIDNIGHT_BLUE to PINK
		setBackground(PINK);

		// djh2-KEC119-21: changed from 30 to 45
		// djh2-YCPlaptop: change from 45 to 100
		// sam-mac: changed from 100 to 150
		this.timer = new Timer(1000 / 150, new ActionListener() {
	...
	protected void paintComponent(Graphics g) {
		...
		// sam-mac: changed from YELLOW to GREEN
